...
{
    public partial class CesiumIonRasterOverlay : System.IDisposable
    {
        internal class ImplementationHandle : SafeHandleZeroOrMinusOneIsInvalid
        {
            public ImplementationHandle(CesiumIonRasterOverlay managed) : base(true)
            {
                SetHandle(DotNet_CesiumForUnity_CesiumIonRasterOverlay_CreateImplementation(Reinterop.ObjectHandleUtility.CreateHandle(managed)));
            }

            [ReliabilityContract(Consistency.WillNotCorruptState, Cer.Success)]
            protected override bool ReleaseHandle()
            {
                DotNet_CesiumForUnity_CesiumIonRasterOverlay_DestroyImplementation(this.handle);
                return true;
            }
        }
        ...
        protected override partial void AddToTileset(CesiumForUnity.Cesium3DTileset tileset)
        {
            unsafe
            {
                ...
                DotNet_CesiumForUnity_CesiumIonRasterOverlay_AddToTileset(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, Reinterop.ObjectHandleUtility.CreateHandle(tileset));
            }
        }
        protected override partial void RemoveFromTileset(CesiumForUnity.Cesium3DTileset tileset)
        {
            unsafe
            {
                ...
                DotNet_CesiumForUnity_CesiumIonRasterOverlay_RemoveFromTileset(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, Reinterop.ObjectHandleUtility.CreateHandle(tileset));
            }
        }

        [DllImport("CesiumForUnityNative-Runtime", CallingConvention=CallingConvention.Cdecl)]
        private static extern System.IntPtr DotNet_CesiumForUnity_CesiumIonRasterOverlay_CreateImplementation(System.IntPtr thiz);
        [DllImport("CesiumForUnityNative-Runtime", CallingConvention=CallingConvention.Cdecl)]
        private static extern void DotNet_CesiumForUnity_CesiumIonRasterOverlay_DestroyImplementation(System.IntPtr implementation);
        [DllImport("CesiumForUnityNative-Runtime", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern void DotNet_CesiumForUnity_CesiumIonRasterOverlay_AddToTileset(System.IntPtr thiz, CesiumForUnity.CesiumIonRasterOverlay.ImplementationHandle implementation, System.IntPtr tileset);
        [DllImport("CesiumForUnityNative-Runtime", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern void DotNet_CesiumForUnity_CesiumIonRasterOverlay_RemoveFromTileset(System.IntPtr thiz, CesiumForUnity.CesiumIonRasterOverlay.ImplementationHandle implementation, System.IntPtr tileset);
    }
}
#endif
